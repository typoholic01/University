...
<form action="" method="post" id="regiform" name="regiform" style="display: none;">
		...
		<td>소속</td>
			<td>
				<select name="major_number" id="major_number" data-msg="학과" style="width: 180px;">
					...
					<option value="1000" class="group_admin">대학본부</option>
		...
		<tr>
			<td>부서(대학본부 소속 선택)</td> 
			<td>
				<select name="admin_department" id="admin_department" data-msg="학과" style="width: 180px;">
					<option value="" >부서선택</option>
					<option value="1001">입학처</option>
					<option value="1002">교육처</option>
					<option value="1003">기획처</option>
					<option value="1004">교육처</option>
				</select>
			</td>
		</tr>
		<tr>
	...
	<!-- 교직원 추가입력 -->
		<tr>
			<td>입사일</td>
			<td><input type="text" name="admin_regidate" id="admin_regidate" class="inputtextcss">(ex: 20170301)</td>
		</tr>

		<tr>
			<td>직위</td>
			<td><input type="text" name="admin_position" id="admin_position" class="inputtextcss"></td>
		</tr>
		<tr>
			<td>
