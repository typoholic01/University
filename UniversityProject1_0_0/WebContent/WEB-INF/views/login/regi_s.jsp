...
<form action="" method="post" id="regiform" name="regiform" style="display: none;">
		...
		<tr>
			<td>입학일</td>
			<td><input type="text" name="student_regidate" id="student_regidate" class="inputtextcss">(ex: 20170301)
			</td>
		</tr>
		<tr> 
			<td>학년</td>
			<td><input type="text" name="student_year" id="student_year" class="inputtextcss1">  학년 </td>
		</tr>
		<tr>
			<td>
